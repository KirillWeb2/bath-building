        ...
        <div className="flex flex-wrap justify-between h-[60px] items-center mx-auto max-w-screen-xl">
          ...
          <div className="z-30 flex items-center lg:order-2">
            <button
              ...
              type="button"
              className="absolute right-[10px] top-[10px] inline-flex items-center mr-0 p-2 ml-1 text-sm text-gray-500 rounded-lg lg:mr-0 lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-[#6c6c6c] dark:focus:ring-gray-600"
