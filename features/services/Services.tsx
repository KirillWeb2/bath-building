...
const billiard: ServiceType[] = [
  {
    ...
    image: billiard1,
    text: "Бильярд",
    desc: "Пирамида (русский бильярд), Карамболь (французский бильярд)",
    modalText:
      "Насладитесь игрой в бильярд в нашем комфортабельном заведении. У нас есть все, что нужно для приятного времяпровождения, включая профессиональные столы для бильярда, кии и шары. Независимо от того, являетесь ли вы профессионалом или новичком, наши столы и услуги помогут вам получить удовольствие от игры. ",
  },
];
